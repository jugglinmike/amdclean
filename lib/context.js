...
Context.prototype.lookup = function(moduleName) {
  return this._cache[moduleName] || "null";
};
 ...
 * @api public
 */
Context.prototype.writeIdentifier = function(identifier) {
  // Use either the passed in namespace or default to using the `window`
  // object.
  var prefix = this.namespace || "window";
...
Context.prototype.register = function(moduleName, identifier) {
  if (!this._cache.hasOwnProperty(moduleName)) {
    this._cache[moduleName] = identifier || moduleName;
  }
};
