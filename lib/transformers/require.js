...
RequireTransformer.prototype.multipleArguments = function() {
  ...
  // The most common code path.
    ...
    this.node.update("(function(" + norml.paramArgs.join(", ") + ")" + arg1.body.source() + ")(" + norml.mapArgs.join(", ") + ")");
  }
};
